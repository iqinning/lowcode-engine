...
import file8 from './files/eslintrc.js.js';
import file7 from './files/gitignore';
import file6 from './files/jsconfig.json';
import file5 from './files/prettierignore';
import file4 from './files/prettierrc.js.js';
import file13 from './files/README.md';
import file16 from './files/src/layouts/BasicLayout/components/Footer/index.jsx.js';
import file17 from './files/src/layouts/BasicLayout/components/Footer/index.style';
import file18 from './files/src/layouts/BasicLayout/components/Logo/index.jsx.js';
import file19 from './files/src/layouts/BasicLayout/components/Logo/index.style';
import file20 from './files/src/layouts/BasicLayout/components/PageNav/index.jsx.js';
import file14 from './files/src/layouts/BasicLayout/index.jsx.js';
import file15 from './files/src/layouts/BasicLayout/menuConfig.js.js';
import file3 from './files/stylelintignore';
import file2 from './files/stylelintrc.js.js';
